...
<div class="header">
    <a style="color: #ffffff;text-decoration: none;" href="indexSignin.html">MIỄN PHÍ VẬN CHUYỂN VỚI ĐƠN HÀNG NỘI THÀNH
        > 300K
                ...
                <div class="site-nav-container-last" style="color:#272727">
                    <div class="cart-view clearfix">
                        ...
                        <table class="table-total">
                            ...
                            <tr>
                                <td><a href="viewcartSignin.html" class="linktocheckout btn btn-success"
                                       style="color: white">Thanh
                                    toán</a></td>
                            </tr>
                            </tbody>
                        </table>
...
<div class="container">
    <p>Status: 1-Chờ xác nhận / 2-Đang giao hàng / 3-Đã giao hàng</p>
</div>
<div class="container viewcart">
    ...
    <form action="" method="post">
        <table class="table table-striped">
            ...
            <tbody>
            <c:forEach var="showOrder" items="${showOrderList}">
                <tr>
                    ...
                    <td>
                        <table class="table table-hover ">
                            ...
                            <c:forEach var="viewShoeDetail" items="${showOrder.viewShoeDetailList}">
                                <tr>
                                    <td>${viewShoeDetail.id}</td>
                                    <td><img src="${viewShoeDetail.url}" width="100" height="100"></td>
                                    <td>${viewShoeDetail.name}</td>
                                    <td>${viewShoeDetail.quantity_buy}</td>
                                    <td><fmt:formatNumber value="${viewShoeDetail.price}"/></td>
                                </tr>
                            </c:forEach>
                        </table>
                    </td>
                    <td><fmt:formatNumber value="${showOrder.total_amount}"/></td>
                    <td style="color: red">
                        <strong>${showOrder.status_id}</strong>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
...
<script src="/js/cartInViewCart.js"></script>
