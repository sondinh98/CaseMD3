                                ...
                                <form id="add-item-form" action="" method="post" class="variants clearfix">
                                    ...
                                    <div class="color-product">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="code" id="color-1" value="#fb4727">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="code" id="color-2" value="#fdfaef">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="code" id="color-3" value="#3e3473">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="code" id="color-4" value="#ffffff">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="code" id="color-5" value="#75e2fb">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="code" id="color-6" value="#cecec8">
                                    ...
                                    <div class="selector-actions">
                                        <div class="quantity-area clearfix">
                                            ...
                                            <input type="text" id="quantity" name="quantity_buy" value="1" min="1"
