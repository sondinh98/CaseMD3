                                ...
                                <div>
                                    ...
                                    <form action="" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="year" name="year" placeholder="Input Year : yyyy">
                                        </div>
                                    ...
                                    <form action="" method="post">
                                        <div class="form-group">
                                            <label for="yearM">Year:</label>
                                            <input type="text" class="form-control" id="yearM" name="year" placeholder="Input Year : yyyy">
                                        </div>
                                        <div class="form-group">
                                            <label for="month">Year:</label>
                                            <input type="text" class="form-control" id="month" name="month" placeholder="Input Month : mm">
                                        </div>
                                        <button type="submit">Find</button>
                                    </form>
                                </div>
